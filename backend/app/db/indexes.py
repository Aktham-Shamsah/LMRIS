...
def create_indexes(db) -> None:
    ...
    db.notification_events.create_index("event_id", unique=True)
    db.notification_events.create_index("application_id")
    db.notification_events.create_index("created_at")
    db.notification_messages.create_index("message_id", unique=True)
    db.notification_messages.create_index("event_id")
    db.notification_messages.create_index("status")
    db.notification_messages.create_index("created_at")
